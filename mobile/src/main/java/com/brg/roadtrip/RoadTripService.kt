...
class RoadTripService : Service() {
    ...
    companion object {
        val READ_ACTION = "com.brg.roadtrip.ACTION_MESSAGE_READ"
        val REPLY_ACTION = "com.brg.roadtrip.ACTION_MESSAGE_REPLY"
        val CONVERSATION_ID = "conversation_id"
        val EXTRA_VOICE_REPLY = "extra_voice_reply"
        private val TAG = RoadTripService::class.java.simpleName
    }
}
